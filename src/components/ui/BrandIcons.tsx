...
/**
 * Brand glyphs for messaging channels. Lucide dropped third-party brand marks,
 * so these are the official simple-icons single-color paths (currentColor), used
 * in the footer contact buttons (DESIGN_CONTRACT §15 / anti-emoji rule).
 */
 ...
 * transparent in any theme, and it inherits the muted button colour + hover-accent.
 */
